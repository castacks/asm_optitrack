...
# (pegasus_app, gps_utils). The isaac-sim container mounts the AirStack
# checkout at /isaac-sim/AirStack, so we append its launch_scripts dir to
# sys.path (override with AIRSTACK_LAUNCH_SCRIPTS_DIR for local runs;
